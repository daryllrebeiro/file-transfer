...
export async function sendFile(client: TransferClient, file: File, metadata: Metadata, onProgress: (bytes: number) => void, signal: AbortSignal) {
	const windowSize = 4; let next = 0; let acknowledged = 0;
